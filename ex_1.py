...
# year that they will turn 100 years old. Note: for this 
# exercise, the expectation is that you explicitly write 
...
hund_year = 100 - int(age)
answer = 2022 + hund_year

print("You will turn 100 years in ", answer, "years.")